...
%     descs_sift{i} = desc_sift;
    ...
    [frame_covdet, desc_covdet] = vl_covdet(im, 'Method', 'DoG', 'descriptor', 'SIFT', 'DoubleImage', true, 'PeakThreshold', peakThresh,'EstimateAffineShape', false,'EstimateOrientation', true, 'Verbose');
